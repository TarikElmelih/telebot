...
export function getData() {
  return [
    ...
    { title: "Kebab", price: 2.99, Image: kebabImg,id:8 },
    { title: "Water", price: 2.99, Image: waterImg,id:9 },
    { title: "Salad", price: 2.99, Image: saladImg,id:10 },
    { title: "Burger", price: 2.99, Image: burgerImg,id:11 },
    { title: "Pizza", price: 2.99, Image: pizzaImg,id:12 },
  ];
}
